...
urlpatterns = [
    ...
    path("categories/<int:category_id>/subcategories/add/", views.subcategory_form, name="admin_subcategory_add"),
    path("categories/<int:category_id>/subcategories/<int:subcategory_id>/edit/", views.subcategory_form, name="admin_subcategory_edit"),
