...
def product_detail(request, slug):
    ...
    variant_data = [
        {
            ...
            "sku": variant.sku,
            "hsn_code": variant.hsn_code or product.hsn_code,
            "size": variant.size,
            "thickness": variant.thickness,
            "colour": variant.colour,
            "unit_type": variant.unit_type or product.unit_type,
            "promo_price": str(variant.promo_price) if variant.promo_price is not None else "",
            "subpromo_price": str(variant.subpromo_price) if variant.subpromo_price is not None else "",
            "agent_redeem_percentage": str(variant.agent_redeem_percentage or 0),
    ...
    base_option = {
        ...
        "promo_price": str(product.promo_price) if product.promo_price is not None else "",
        "subpromo_price": str(product.subpromo_price) if product.subpromo_price is not None else "",
        "agent_redeem_percentage": str(product.agent_redeem_percentage or 0),
        "size": product.size,
